...
inline data_flow::LibraryNodeCode LibraryNodeType_Rsqrt("ml::Rsqrt");

class RsqrtNode : public ElementWiseDataflowTensorNode {
public:
    RsqrtNode(
        size_t element_id,
...
typedef SimpleElementWiseDataflowTensorNodeSerializer<RsqrtNode> RsqrtNodeSerializer;
