...
class HardSigmoidNode : public ElementWiseDataflowTensorNode {
public:
    HardSigmoidNode(
        size_t element_id,
...
typedef SimpleElementWiseDataflowTensorNodeSerializer<HardSigmoidNode> HardSigmoidNodeSerializer;
