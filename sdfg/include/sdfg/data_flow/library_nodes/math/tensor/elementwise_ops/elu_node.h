...
class EluNode : public ElementWiseDataflowTensorNode {
public:
    EluNode(
        size_t element_id,
    ...
    int mandatory_input_count() const override { return 2; }
...
typedef SimpleElementWiseDataflowTensorNodeSerializer<EluNode> EluNodeSerializer;
