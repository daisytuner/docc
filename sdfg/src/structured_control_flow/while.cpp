...
bool While::accept(visitor::ActualStructuredSDFGVisitor& visitor) {
    return visitor.visit(*this);
}

void While::validate(const Function& function) const {
    this->root_->validate(function);
};

const Sequence& While::root() const {
    return *this->root_;
};
...
void While::replace(const symbolic::ExpressionMapping& replacements) {
...
bool Break::accept(visitor::ActualStructuredSDFGVisitor& visitor) {
    return visitor.visit(*this);
}
...
bool Continue::accept(visitor::ActualStructuredSDFGVisitor& visitor) {
    return visitor.visit(*this);
}
