...
PrimitiveType Structure::primitive_type() const {
    return PrimitiveType::Void;
};

bool Structure::is_symbol() const {
    return false;
};

TypeID Structure::type_id() const {
...
std::string Structure::print() const {
    return "Structure(" + this->name_ + ")";
}

bool Structure::is_pointer_like() const {
    return this->name_.starts_with("std::shared_ptr");
}
...
const std::string& StructureDefinition::name() const {
    return this->name_;
};

bool StructureDefinition::is_packed() const {
    return this->is_packed_;
};

size_t StructureDefinition::num_members() const {
