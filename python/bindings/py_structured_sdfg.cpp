...
#include <sdfg/passes/dataflow/tensor_elimination.h>
...
void PyStructuredSDFG::expand() {
    ...
    auto tensor_elimination_pipeline = sdfg::passes::tensor_elimination_pipeline();
    tensor_elimination_pipeline.run(builder_opt, analysis_manager);
