#include "sdfg/transformations/offloading/cuda_memset_offloading_expansion.h"
...
std::string CUDAMemsetOffloadingExpansion::create_device_container(
...
void CUDAMemsetOffloadingExpansion::create_allocate(
...
void CUDAMemsetOffloadingExpansion::create_deallocate(
    builder::StructuredSDFGBuilder& builder,
    structured_control_flow::Sequence& sequence,
    structured_control_flow::Block& block,
    const std::string& device_container,
...
void CUDAMemsetOffloadingExpansion::create_copy_from_device_with_deallocation(
    builder::StructuredSDFGBuilder& builder,
    structured_control_flow::Sequence& sequence,
    structured_control_flow::Block& block,
...
CUDAMemsetOffloadingExpansion::CUDAMemsetOffloadingExpansion(::sdfg::stdlib::MemsetNode& memset_node)
    : memset_node_(memset_node) {}

std::string CUDAMemsetOffloadingExpansion::name() const { return "CUDAMemsetOffloadingExpansion"; }

bool CUDAMemsetOffloadingExpansion::
...
void CUDAMemsetOffloadingExpansion::
...
void CUDAMemsetOffloadingExpansion::to_json(nlohmann::json& j) const {
