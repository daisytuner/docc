...
ROCFFTDataTransferExtraction::ROCFFTDataTransferExtraction(math::tensor::FFTNodeBase& fft_node) : fft_node_(fft_node) {}

std::string ROCFFTDataTransferExtraction::name() const { return "ROCFFTDataTransferExtraction"; }

bool ROCFFTDataTransferExtraction::
    can_be_applied(builder::StructuredSDFGBuilder& builder, analysis::AnalysisManager& analysis_manager) {
    if (this->fft_node_.implementation_type().value() != rocm::ImplementationType_ROCMWithTransfers.value()) {
        return false;
    }
...
void ROCFFTDataTransferExtraction::
    ...
    this->fft_node_.implementation_type() = rocm::ImplementationType_ROCMWithoutTransfers;
}

void ROCFFTDataTransferExtraction::to_json(nlohmann::json& j) const {
