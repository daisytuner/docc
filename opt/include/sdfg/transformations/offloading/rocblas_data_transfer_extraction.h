...
class ROCBLASDataTransferExtraction : public transformations::Transformation {
private:
...
public:
    ROCBLASDataTransferExtraction(math::blas::BLASNode& blas_node);
    ...
    static ROCBLASDataTransferExtraction from_json(builder::StructuredSDFGBuilder& builder, const nlohmann::json& j);
};
