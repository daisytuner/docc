...
class GpuMmaTransform : public transformations::Transformation {
    ...
    const sdfg::gpu::GpuArch* arch_;
    bool expanded_ = false;

public:
    GpuMmaTransform(sdfg::math::tensor::MatMulNode& node, const sdfg::gpu::GpuArch* arch);
    ...
    static GpuMmaTransform from_json(builder::StructuredSDFGBuilder& builder, const nlohmann::json& desc);
};
