...
inline passes::Pipeline map_fusion(bool allow_init_hoist = true, bool cons_into_prod_only = false) {
    passes::Pipeline p("MapFusion");

    p.register_pass<normalization::MapFusionPass>(allow_init_hoist, cons_into_prod_only);
