...
void expect_schedule_retained(
    ...
    EXPECT_EQ(schedule.value(), ScheduleType_ROCM::value());
    EXPECT_EQ(ScheduleType_ROCM::target_level(schedule), expected_level);
    EXPECT_EQ(ScheduleType_ROCM::parallel_size(schedule)->as_int(), expected_parallel_size);
