...
TEST(StrideMinimizationTest, Apply_SimpleInterchange) {
    ...
    auto* outer = dyn_cast<structured_control_flow::StructuredLoop*>(&new_root.at(0));
    ASSERT_NE(outer, nullptr);
    EXPECT_EQ(outer->indvar()->get_name(), "j");

    auto* inner = dyn_cast<structured_control_flow::StructuredLoop*>(&outer->root().at(0));
...
TEST(StrideMinimizationTest, Polybench_correlation) {
...

    {
        ...
        auto loop_j_3 = dyn_cast<structured_control_flow::StructuredLoop*>(&loop_k_3->root().at(0));
...
TEST(StrideMinimizationTest, Polybench_covariance) {
...

    {
        ...
        auto loop_i_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&root.at(0));
        EXPECT_TRUE(loop_i_2 != nullptr);
        EXPECT_TRUE(SymEngine::eq(*loop_i_2->init(), *symbolic::integer(0)));
        ...
        auto loop_i_3 = dyn_cast<structured_control_flow::StructuredLoop*>(&root.at(1));
        EXPECT_TRUE(loop_i_3 != nullptr);
        EXPECT_TRUE(SymEngine::eq(*loop_i_3->init(), *symbolic::integer(0)));
        ...
        auto loop_i_4 = dyn_cast<structured_control_flow::StructuredLoop*>(&root.at(2));
        EXPECT_TRUE(loop_i_4 != nullptr);
        EXPECT_TRUE(SymEngine::eq(*loop_i_4->init(), *symbolic::integer(0)));
...
TEST(StrideMinimizationTest, Polybench_gemm) {
    ...
    ***/

    {
        ...
        EXPECT_TRUE(SymEngine::eq(*loop_i_2->update(), *symbolic::add(loop_i_2->indvar(), symbolic::integer(1))));
        EXPECT_EQ(loop_i_2->root().size(), 1);
        auto loop_k_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&loop_i_2->root().at(0));
        ...
        auto loop_j_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&loop_k_2->root().at(0));
        EXPECT_TRUE(loop_j_2 != nullptr);
...
TEST(StrideMinimizationTest, Polybench_symm) {
    ...
    ***/

    {
        ...
        auto loop_i = dyn_cast<structured_control_flow::StructuredLoop*>(&root.at(0));
        ...
        auto loop_j = dyn_cast<structured_control_flow::StructuredLoop*>(&body_i.at(0));
        ...
        auto* block_init = dyn_cast<structured_control_flow::Block*>(&body_j.at(0));
        EXPECT_NE(block_init, nullptr);

        // body_j[1]: for k [0, i)
        auto loop_k = dyn_cast<structured_control_flow::StructuredLoop*>(&body_j.at(1));
        ...
        auto* block_final = dyn_cast<structured_control_flow::Block*>(&body_j.at(2));
...
TEST(StrideMinimizationTest, Polybench_gemver) {
    ...
    */

    {
        ...
        auto loop_j_1 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_i_1.at(0));
        EXPECT_TRUE(loop_j_1 != nullptr);
        EXPECT_EQ(loop_j_1->indvar()->get_name(), "j_1");

        auto loop_j_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&root.at(1));
        EXPECT_TRUE(loop_j_2 != nullptr);
        EXPECT_EQ(loop_j_2->indvar()->get_name(), "j_2");
        auto& body_j_2 = loop_j_2->root();

        auto loop_i_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_j_2.at(0));
        EXPECT_TRUE(loop_i_2 != nullptr);
        ...
        auto loop_j_4 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_i_4.at(0));
        EXPECT_TRUE(loop_j_4 != nullptr);
...
TEST(StrideMinimizationTest, Polybench_syrk) {
    ...
    ***/

    {
        ...
        {
            auto loop_j_1 = dyn_cast<structured_control_flow::StructuredLoop*>(&loop_i->root().at(0));
            EXPECT_TRUE(loop_j_1 != nullptr);
            EXPECT_TRUE(SymEngine::eq(*loop_j_1->init(), *symbolic::integer(0)));
...
TEST(StrideMinimizationTest, Polybench_doitgen) {
    ...
    */

    {
        ...
        auto loop_r = dyn_cast<structured_control_flow::StructuredLoop*>(&root.at(0));
        EXPECT_TRUE(loop_r != nullptr);
        EXPECT_EQ(loop_r->indvar()->get_name(), "r");
        auto& body_r = loop_r->root();

        auto loop_q = dyn_cast<structured_control_flow::StructuredLoop*>(&body_r.at(0));
        EXPECT_TRUE(loop_q != nullptr);
        EXPECT_EQ(loop_q->indvar()->get_name(), "q");
        auto& body_q = loop_q->root();

        auto loop_p_1 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_q.at(0));
        EXPECT_TRUE(loop_p_1 != nullptr);
        EXPECT_EQ(loop_p_1->indvar()->get_name(), "p_1");
        auto& body_p_1 = loop_p_1->root();

        auto loop_s = dyn_cast<structured_control_flow::StructuredLoop*>(&body_q.at(1));
        EXPECT_TRUE(loop_s != nullptr);
        EXPECT_EQ(loop_s->indvar()->get_name(), "s");
        auto& body_s = loop_s->root();

        auto loop_p_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_s.at(0));
        EXPECT_TRUE(loop_p_2 != nullptr);
        EXPECT_EQ(loop_p_2->indvar()->get_name(), "p_10");

        auto loop_p_3 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_q.at(2));
...
TEST(StrideMinimizationTest, Polybench_mvt) {
    ...
    */

    {
        ...
        auto loop_j_1 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_loop_i_1.at(0));
        EXPECT_TRUE(loop_j_1 != nullptr);
        ...
        auto loop_j_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_loop_i_2.at(0));
        EXPECT_TRUE(loop_j_2 != nullptr);
...
TEST(StrideMinimizationTest, Polybench_cholesky) {
    ...
    */

    {
        ...
        auto loop_j_1 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_i.at(0));
        EXPECT_TRUE(loop_j_1 != nullptr);
        EXPECT_TRUE(SymEngine::eq(*loop_j_1->init(), *symbolic::integer(0)));
        ...
        auto loop_k_1 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_j_1.at(0));
        EXPECT_TRUE(loop_k_1 != nullptr);
        ...
        auto loop_k_2 = dyn_cast<structured_control_flow::StructuredLoop*>(&body_i.at(1));
        EXPECT_TRUE(loop_k_2 != nullptr);
        EXPECT_TRUE(SymEngine::eq(*loop_k_2->init(), *symbolic::integer(0)));
...
TEST(StrideMinimizationTest, Polybench_fdtd_2d) {
    ...
    // todo: get outermost loop
    auto outermost_loop = sdfg::dyn_cast<sdfg::structured_control_flow::For*>(&root->at(0));
